                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formRincianPenilaian" method="post" action="<?=base_url('pegawai/rincianpenilaian') ?>">
    ...
    $('form#formRincianPenilaian').submitAjax({
     ...
     $('button#btn-menambahkan').on('click' , function(){
        ...
        $('table#table-rincianpenilaian').on('click', '.btn-light', function (){
            ...
            $.get(`${baseurl}/pegawai/rincianpenilaian/${id}`).done((e)=>{
         ...
         $('table#table-rincianpenilaian').on('click', '.btn-danger', function (){
            ...
            if(konfirmasi === true){
                ...
                $.post(`${baseurl}/pegawai/rincianpenilaian`, {id:_id, _method:'delete'}).done(function(e){
                    $('table#table-rincianpenilaian').DataTable().ajax.reload();
                });
                }
          });
        ...
        $('table#table-rincianpenilaian').DataTable({
            ...
            serverSide: true,
            ajax:{
                url: "<?=base_url('/pegawai/rincianpenilaian/all')?>",
                method: 'GET'
            },
            columns:[
