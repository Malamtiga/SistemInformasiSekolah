...
<?=$this->section('content')?>
            ...
            <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Table Jadwal Mata Pelajaran</h6>
                        </div>
                        <div class="card-body">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formJadwal" method="post" action="<?=base_url('pegawai/jadwal') ?>">
    ...
    $('form#formJadwal').submitAjax({
     ...
     $('button#btn-menambahkan').on('click' , function(){
        ...
        $('table#table-jadwal').on('click', '.btn-light', function (){
         ...
         $('table#table-jadwal').on('click', '.btn-danger', function (){
            ...
            if(konfirmasi === true){
                ...
                $.post(`${baseurl}/pegawai/jadwal`, {id:_id, _method:'delete'}).done(function(e){
                    $('table#table-jadwal').DataTable().ajax.reload();
                });
                }
          });
        ...
        $('table#table-jadwal').DataTable({
            ...
            serverSide: true,
            ajax:{
                url: "<?=base_url('/pegawai/jadwal/all')?>",
                method: 'GET'
            },
            columns:[
