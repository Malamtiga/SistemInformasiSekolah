...
<head>
    ...
    <title>Sistem Informasi Sekolah - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <?= $this->include('backend/widgetssis/sidebar')?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Melakukan Logout?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Yakin Melakukan Logout? </div>
